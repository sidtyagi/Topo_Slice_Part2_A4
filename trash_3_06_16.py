...
# Video from h1 <----> h3 and vice-versa
...
# Video from h1 <----> h4 and vice-versa
('00-00-00-00-00-01', EthAddr('00:00:00:00:00:01'),EthAddr('00:00:00:00:00:03'), 80): '00-00-00-00-00-03',
('00-00-00-00-00-03', EthAddr('00:00:00:00:00:01'),EthAddr('00:00:00:00:00:03'), 80): '00-00-00-00-00-04',
...
# Non Video from h1 <----> h3 and vice-versa
...
# Non Video from h1 <----> h4 and vice-versa
    ...
    def _handle_PacketIn (self, event):
        ...
        def forward (message = None):
            ...
            if packet.dst.is_multicast:
                ...
                try:
                    """ Add your logic here"""
		    key=(this_dpid, packet.src, packet.dst, packet.find('tcp').dstport)
		    if not self.portmap.get(key):
			print 'Trying using the TCP source port'
			key=(this_dpid, packet.src, packet.dst, packet.find('tcp').srcport)
			if not self.portmap.get(key):
				#print 'Now trying with tcp src port'
				raise AttributeError
		    far_end_dpid=self.portmap.get(key)
		    install_fwdrule(event,packet,self.adjacency[this_dpid][far_end_dpid])
